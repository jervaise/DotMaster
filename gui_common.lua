...
function DM:CreateGUI()
  ...
  author:SetPoint("CENTER", footerFrame, "CENTER", 0, -6) -- Reduced offset for better centering
  ...
  statusMessage:SetPoint("CENTER", footerFrame, "CENTER", 0, 6)         -- Reduced from 16 to 6 for better centering
