...
function DM:CreateGUI()
  ...
  author:SetPoint("CENTER", footerFrame, "CENTER", 0, -18) -- Moved further down from -12 to -18
  ...
  statusMessage:SetPoint("CENTER", footerFrame, "CENTER", 0, -6)        -- Moved further down from 0 to -6
