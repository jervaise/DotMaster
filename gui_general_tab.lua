...
function DM:CreateGeneralTab(parent)
  ...
  -- Create Integrate button for Plater integration (for testing)
  local integrateButton = CreateFrame("Button", nil, contentPanel, "UIPanelButtonTemplate")
  integrateButton:SetSize(100, 24)
  integrateButton:SetPoint("BOTTOM", contentPanel, "BOTTOM", 0, 10)
  integrateButton:SetText("Integrate")
  integrateButton:SetScript("OnClick", function()
    DM:InstallPlaterMod()
  end)
